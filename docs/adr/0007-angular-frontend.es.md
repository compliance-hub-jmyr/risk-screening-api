...
- Componentes de UI: biblioteca de componentes enterprise-grade lista para usar
...
| Tamano de bundle inicial | Mayor | Menor | Menor |
...
| Toast / Notificaciones | `p-toast` + `MessageService` integrado | Solo `MatSnackBar` (limitado) |
...
**Negativo:**
- Bundle inicial mas grande que React/Vue para una SPA pequena
...
**Mitigacion:**
- Para el alcance de este proyecto (dos modulos: suppliers + screening) el tamano del bundle es irrelevante
