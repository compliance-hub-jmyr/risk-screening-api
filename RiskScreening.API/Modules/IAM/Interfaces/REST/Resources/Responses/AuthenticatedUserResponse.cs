...
public record AuthenticatedUserResponse(
    ...
    string Id,
    [property:
        SwaggerSchema(Description = "Email address of the authenticated user.", Format = "email", Nullable = false)]
    string Email,
    ...
    List<string> Roles,
    [property:
        SwaggerSchema(Description = "JWT bearer token to include in the Authorization header.", Nullable = false)]
    string Token
);